...
public class BlocRestController {
   ...
   /* @PostMapping("/affecter-chambres")
    ...
    @PostMapping("/affecterblocafoyer/{nomB}/{nomF}")
    public ResponseEntity<Bloc> affecterFoyerAUniversite(@RequestParam("nomB") String nomBloc, @RequestParam("nomF") String nomFoyer) {
        Bloc bloc =iBlocService.affecterBlocAFoyer(nomBloc,nomFoyer);
